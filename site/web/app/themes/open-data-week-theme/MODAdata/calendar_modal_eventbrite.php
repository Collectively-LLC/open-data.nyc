...
//////// DETAILS MODALS ////////
	foreach ($events as $id => $event) {
		...
		if(strpos( $allmeta[cmb_pre().'register'], 'eventbrite' ) > 0 ) {
			...
			$eb_container_id = $eb_event_id.'-'.$id;
			...
			echo '<div class="modal fade" id="register'.$id.'" tabindex="-1" role="dialog" aria-hidden="true">
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				        ...
				        <div id="eventbrite-widget-container-'.$eb_container_id.'" style="height: 0"></div>
				    </div>
				  </div>
				</div>
				...
				function load_register'.$id.'() { 
					if(jQuery(\'#eventbrite-widget-container-'.$eb_container_id.'\').html() == "") {
					    ...
					    window.EBWidgets.createWidget({
					        ...
					        widgetType: \'checkout\',
					        eventId: \''.$eb_event_id.'\',
					        iframeContainerId: \'eventbrite-widget-container-'.$eb_container_id.'\',
					        // Optional
